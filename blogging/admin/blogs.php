            ...
            $query = "select * from blogs";
                    ...
                    if(mysqli_num_rows($result) > 0){
                        while($r = mysqli_fetch_assoc($result)){
                            ...
                            echo "<tr> <td>" . $r['id'] . "</td> <td>".$r['subject'] . "</td> <td>".$category_name."</td> <td>".$user_name."</td> <td>".$r['created_date']."</td> <td> <a  href='blogs.php?id=".$r['id']. "'> Delete</a> </td> <td> <a  href='blog-details.php?id=".$r['id']. "'> Details</a> </td> <td> <a  href='edit-blog.php?id=".$r['id']. "'> Edit</a> </td> </tr>";
